...
void CRisovanieDlg::OnMouseMove(UINT nFlags, CPoint point)
{
	// TODO: Add your message handler code here and/or call default

	if (PtInRect(&Next, point))
	{
		PIC.LoadBitmapW(IDB_BITMAP36);
		mpic1.SetBitmap(PIC);
		PIC.DeleteObject();
		Sleep(50);
	}
...
void CRisovanieDlg::OnLButtonDown(UINT nFlags, CPoint point)
{
	// TODO: Add your message handler code here and/or call default
...
void CRisovanieDlg::OnRButtonDown(UINT nFlags, CPoint point)
{
	// TODO: Add your message handler code here and/or call default
